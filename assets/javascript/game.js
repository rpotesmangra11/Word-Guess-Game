// //Global Variables
// //==========================================================================
// const songOptions = ["Inolvidable", "Farsante", "Dembow", "Calypso"]; // Creates an array that lists out all of the song options.
// let wins = 0;
// let loss = 0;
// let chosenSong;
// let guessesLeft = 12;
// let userGuesses = []; //Array for letters the user guessed
// let wrongLetter = []; //Array for the letters wrong guess
// let underScores = []; //Underscore array based on letters in the song
...
//   let randNum = Math.floor(Math.random() * songOptions.length);
//   let chosenSong = songOptions[randNum];
